...
export default function ContactDetail() {
  ...
  // Seed the editable fields whenever the card data changes (initial load or refetch).
  const [seededData, setSeededData] = useState<typeof card.data>(undefined);
  if (card.data && card.data !== seededData) {
