 ...
 * customer session), plus an opt-in per-business Origin allowlist
 * (`Business.widgetAllowedOrigins`, enforced in `WidgetService.assertOriginAllowed`).
 * See WidgetService docs for the full model.
 */
@Public()
@Controller('widget')
