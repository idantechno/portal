...
export default function ContactDetail() {
  ...
  // Seed the editable fields once the card loads, re-seeding whenever the
  // loaded contact changes (adjusting state during render, per React docs,
  // instead of an effect — avoids an extra render and a flash of empty fields).
