...
export default function ContactDetail() {
  ...
  // Seed the editable fields once the card loads (derived during render, not
  // in an effect, so it doesn't cascade an extra render).
  const [seededFrom, setSeededFrom] = useState(card.data);
