 ...
 * customer session). `Business.widgetAllowedOrigins` is enforced at the
 * application layer by `WidgetService#assertOriginAllowed`, not via CORS
 * headers — see WidgetService docs for the model.
 */
@Public()
@Controller('widget')
