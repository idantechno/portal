...
export default function ContactDetail() {
  ...
  // Seed the editable fields whenever a different contact's card loads
  // (state adjustment during render, per https://react.dev/learn/you-might-not-need-an-effect).
  const [seededContactId, setSeededContactId] = useState<string | null>(null);
  if (card.data && card.data.contact.id !== seededContactId) {
