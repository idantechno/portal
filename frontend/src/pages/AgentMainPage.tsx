...
import MainAgent from "./business/MainAgent";
  ...
  return (
    <div className="h-screen flex flex-col bg-neutral-50">
      <header className="border-b border-neutral-200 bg-white shrink-0">
        <div className="px-4 sm:px-6 h-14 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <span className="text-sm font-medium truncate hidden sm:inline">הסוכן הראשי</span>
          </div>
      ...
      <main className="flex-1 min-h-0 overflow-hidden">
          ...
          <div className="h-full flex items-center justify-center px-4">
            <Card className="p-8 max-w-md text-center space-y-4">
              ...
              <p className="text-neutral-600 text-sm">
                הסוכן הראשי מכוון אותך בתוך העסק שלך. צור עסק כדי להתחיל.
              </p>
        ...
        {activeId && <MainAgent businessId={activeId} />}
      </main>
    </div>
  );
}
