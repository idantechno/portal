...
export class InitialSchema1783031636916 implements MigrationInterface {
  name = 'InitialSchema1783031636916';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "automation_rules" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "name" character varying(255) NOT NULL, "enabled" boolean NOT NULL DEFAULT true, "trigger" character varying(64) NOT NULL, "conditions" jsonb NOT NULL DEFAULT '[]'::jsonb, "actions" jsonb NOT NULL DEFAULT '[]'::jsonb, "created_by_user_id" uuid, "last_run_at" TIMESTAMP WITH TIME ZONE, "run_count" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_378bed501eacc036895837121c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d3d3951c311fe99b99390e96b7" ON "automation_rules"  ("business_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0233c4b3ab1eb4b17dc42c705b" ON "automation_rules"  ("trigger") `,
    );
    await queryRunner.query(
      `CREATE TABLE "invoices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "number" character varying(32) NOT NULL, "status" character varying(16) NOT NULL DEFAULT 'draft', "customer_name" character varying(255), "amount_cents" integer NOT NULL DEFAULT '0', "currency" character varying(8) NOT NULL DEFAULT 'ILS', "line_items" jsonb NOT NULL DEFAULT '[]'::jsonb, "issued_at" TIMESTAMP WITH TIME ZONE, "due_at" TIMESTAMP WITH TIME ZONE, "paid_at" TIMESTAMP WITH TIME ZONE, "pdf_url" character varying(512), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_668cef7c22a427fd822cc1be3ce" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8f96c84343bd7d6cb4374e9788" ON "invoices"  ("business_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "plan_code" character varying(32) NOT NULL DEFAULT 'free', "status" character varying(16) NOT NULL DEFAULT 'active', "provider" character varying(16) NOT NULL DEFAULT 'manual', "provider_ref" character varying(255), "current_period_end" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_subscription_business" ON "subscriptions"  ("business_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "green_invoice_connections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "encrypted_credentials" text, "environment" character varying(16) NOT NULL DEFAULT 'sandbox', "status" character varying(16) NOT NULL DEFAULT 'disconnected', "account_name" character varying(255), "connected_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_5ed020557e90e27df7f4b731503" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_green_invoice_business" ON "green_invoice_connections"  ("business_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "integrations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "provider" character varying(16) NOT NULL, "status" character varying(16) NOT NULL DEFAULT 'disconnected', "account_email" character varying(255), "encrypted_tokens" text, "scopes" jsonb NOT NULL DEFAULT '[]'::jsonb, "connected_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_9adcdc6d6f3922535361ce641e8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7143c24801c4d02ee1e3098bae" ON "integrations"  ("business_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_integration_business_provider" ON "integrations"  ("business_id", "provider") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "notifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "user_id" uuid, "type" character varying(16) NOT NULL DEFAULT 'system', "title" character varying(255) NOT NULL, "body" text, "link" character varying(512), "read" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_6a72c3c0f683f6462415e653c3a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b1b5043ada10de525123ccdd40" ON "notifications"  ("business_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "title" character varying(255) NOT NULL, "description" text, "status" character varying(16) NOT NULL DEFAULT 'open', "priority" character varying(16) NOT NULL DEFAULT 'medium', "source" character varying(16) NOT NULL DEFAULT 'manual', "due_at" TIMESTAMP WITH TIME ZONE, "completed_at" TIMESTAMP WITH TIME ZONE, "related_type" character varying(32), "related_id" uuid, "created_by_user_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_cc8db5286af61bdbd995f8979b" ON "tasks"  ("business_id") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cc8db5286af61bdbd995f8979b"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b1b5043ada10de525123ccdd40"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."uq_integration_business_provider"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7143c24801c4d02ee1e3098bae"`,
    );
    await queryRunner.query(`DROP TABLE "integrations"`);
    await queryRunner.query(`DROP INDEX "public"."uq_green_invoice_business"`);
    await queryRunner.query(`DROP TABLE "green_invoice_connections"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP INDEX "public"."uq_subscription_business"`);
    await queryRunner.query(`DROP TABLE "subscriptions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8f96c84343bd7d6cb4374e9788"`,
    );
    await queryRunner.query(`DROP TABLE "invoices"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0233c4b3ab1eb4b17dc42c705b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d3d3951c311fe99b99390e96b7"`,
    );
